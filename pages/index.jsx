export default function HomePage() {
  return (
    <section className="flex flex-col items-center justify-center min-h-[calc(100vh-4rem)] px-4">
      <div className="text-center space-y-6 opacity-0 animate-fade-in-up">
        ...
        <div className="opacity-0 animate-fade-in-up animate-delay-300">
          <a
            ...
            download
            className="inline-flex items-center gap-2 px-6 py-3 rounded-full border border-gray-300 dark:border-gray-600 text-sm font-medium hover:bg-gray-100 dark:hover:bg-white/5 transition-all duration-200 hover:border-primary-500 hover:text-primary-500"
          >
      ...
      <p className="absolute bottom-8 text-sm text-gray-400 dark:text-gray-600 hidden sm:block">
        &mdash; What you see is all there is.
      </p>
    </section>
  );
}
